...
// Simple Apple Icon Component (Updated color)
const AppleIcon = () => (
                ...
                <div className="bg-white/80 backdrop-blur-md border border-tarmac-200 rounded-3xl p-8 pt-12 shadow-2xl w-full">
                    ...
                    <div className="text-center mb-8 mt-4">
                        <h1 className="text-3xl font-black text-tarmac-900 mb-2 tracking-tight italic">
                            Welcome to <span className='text-secondary-500'>Go</span>Drive
                        </h1>
                    ...
                    <form className="space-y-5">
                        ...
                        <div className="space-y-1">
                            <label className="text-tarmac-600 text-sm font-bold ml-1">Full Name</label>
                            <div className="relative group">
                                <input
                                    type="text"
                        ...
                        <div className="flex items-center justify-between text-xs sm:text-sm pt-2">
                            <p className="text-tarmac-500">
                                ...
                                <Link href="/signin" className="text-primary-600 hover:text-primary-800 font-bold transition-colors">
                                    Sign In
                                </Link>
                            </p>
                        </div>
                    ...
                    <div className="mt-8">
                        <div className='flex items-center justify-center'>
                            ...
                            <h1 className='text-tarmac-400 text-xs font-bold uppercase tracking-wider text-center my-4 mx-5'>or Sign up with</h1>
